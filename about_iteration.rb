...
class AboutIteration < Neo::Koan
  ...
  #   # code to read 'file'
  #
  # ANSWER: File.open loads the entire file into memory while supplying the block only loads one line into memory at any one time. Or is it because if you don't supply a block, you'll need to manually close the file?
  # CORRECT ANSWER: Files need to be closed. No difference to memory use. 
  #
